...
class ExtSEIRSNetworkModel():
    ...
    def __init__(self, G, beta, sigma, lamda, gamma,
        ...
        if (node_groups):
            ...
            for groupName, nodeList in node_groups.items():
                ...
                self.nodeGroupData[groupName]['numQ_sym'][0] = numpy.count_nonzero(
                    self.nodeGroupData[groupName]['mask'] * self.X == self.Q_sym)
                self.nodeGroupData[groupName]['numQ_asym'][0] = numpy.count_nonzero(
    ...
    def figure_infections(self, plot_S=False, plot_E='stacked', plot_I_pre='stacked', plot_I_sym='stacked',
                          ...
                          shaded_reference_results=None, shaded_reference_label='reference',
                          vlines=[], vline_colors=[], vline_styles=[], vline_labels=[],
                          ylim=None, xlim=None, legend=True, title=None, side_title=None, plot_percentages=False,
                          figsize=(12, 8), use_seaborn=True, show=True):
