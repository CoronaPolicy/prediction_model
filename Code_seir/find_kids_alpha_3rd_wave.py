...
if __name__ == "__main__":
    ...
    for i in range(100):
        ...
        graphs_for_sim = []
        alpha_deg_young = np.random.randint(50, 150)/100
        alpha_deg_kids = np.random.random() + 1
        layer_info = {'0-9': {'ageBrackets': ['0-9'], 'meanDegree': alpha_deg_kids*8.6,
                              'meanDegree_CI': (alpha_deg_kids*0.0, alpha_deg_kids*17.7)},
        ...
        demographic_graphs, individual_ageGroups, households = generate_demographic_contact_network(
            ...
            distancing_scales=list(scale_out), isolation_groups=[], verbose=False, layer_info=layer_info)
        ...
        input_json = {'N': N,
                      ...
                      'alpha_deg_young': alpha_deg_young,
                      'alpha_deg_kids': alpha_deg_kids,
                      'max_value': max_value,
